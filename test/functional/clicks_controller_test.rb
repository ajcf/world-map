...
class ClicksControllerTest < ActionController::TestCase
  ...
  test "should create click" do
    assert_difference('Click.count') do
      post :create, click: { click_type_id: @click.click_type_id, count: @click.count, country_id: @click.country_id }
    end
  ...
  test "should update click" do
    put :update, id: @click, click: { click_type_id: @click.click_type_id, count: @click.count, country_id: @click.country_id }
    assert_redirected_to click_path(assigns(:click))
  end
